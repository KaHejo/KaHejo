...
class EmissionFactorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.emission-factors.index')->with('success', 'Faktor emisi berhasil ditambahkan');
    }
    ...
    public function update(Request $request, EmissionFactor $emissionFactor)
    {
        ...
        return redirect()->route('admin.emission-factors.index')->with('success', 'Faktor emisi berhasil diperbarui');
    }

    public function destroy(EmissionFactor $emissionFactor)
    {
        $emissionFactor->delete();
        return redirect()->route('admin.emission-factors.index')->with('success', 'Faktor emisi berhasil dihapus');
    }
}
