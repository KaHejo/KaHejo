...
>>>>>>> 052108013de51d485f13733c4b21da8f70e4df53
                    ...
                    <!-- Transportation -->
                    <div class="form-group transform transition-all duration-300 hover:scale-[1.02]" data-aos="fade-up" data-aos-delay="200">
                        <label for="transportation" class="block text-sm font-medium text-gray-700 dark:text-dark-text-primary mb-2">
                            Daily Transportation (km)
                            <span class="text-red-500">*</span>
                            <span class="ml-1 text-gray-400 dark:text-dark-text-secondary cursor-help" data-tooltip="Total distance traveled per day by all means of transport">
                                <i class="fas fa-question-circle"></i>
                            </span>
                        </label>
                        <div class="mt-1 relative rounded-lg shadow-sm group">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fas fa-car text-gray-400 dark:text-dark-text-secondary group-hover:text-green-500 transition-colors"></i>
                            </div>
                            <input type="number" name="transportation" id="transportation" 
                                ...
                                required>
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 dark:text-dark-text-secondary sm:text-sm">km</span>
                            </div>
                        </div>
                        <p class="mt-2 text-sm text-gray-500 dark:text-dark-text-secondary hidden" id="transportationHelp">
                            Enter your daily transportation distance in kilometers (km)
                        </p>
                    </div>

                    <!-- Waste -->
                    <div class="form-group transform transition-all duration-300 hover:scale-[1.02]" data-aos="fade-up" data-aos-delay="300">
                        <label for="waste" class="block text-sm font-medium text-gray-700 dark:text-dark-text-primary mb-2">
                            Monthly Waste (kg)
                            <span class="text-red-500">*</span>
                            <span class="ml-1 text-gray-400 dark:text-dark-text-secondary cursor-help" data-tooltip="Total weight of waste generated per month">
                                <i class="fas fa-question-circle"></i>
                            </span>
                        </label>
                        <div class="mt-1 relative rounded-lg shadow-sm group">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fas fa-trash text-gray-400 dark:text-dark-text-secondary group-hover:text-green-500 transition-colors"></i>
                            </div>
                            <input type="number" name="waste" id="waste" 
                                ...
                                required>
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 dark:text-dark-text-secondary sm:text-sm">kg</span>
                            </div>
                        </div>
                        <p class="mt-2 text-sm text-gray-500 dark:text-dark-text-secondary hidden" id="wasteHelp">
                            Enter your monthly waste generation in kilograms (kg)
                        </p>
                    </div>

                    <!-- Water Usage -->
                    <div class="form-group transform transition-all duration-300 hover:scale-[1.02]" data-aos="fade-up" data-aos-delay="400">
                        <label for="water" class="block text-sm font-medium text-gray-700 dark:text-dark-text-primary mb-2">
                            Monthly Water Usage (m³)
                            <span class="text-red-500">*</span>
                            <span class="ml-1 text-gray-400 dark:text-dark-text-secondary cursor-help" data-tooltip="Total water consumption per month in cubic meters">
                                <i class="fas fa-question-circle"></i>
                            </span>
                        </label>
                        <div class="mt-1 relative rounded-lg shadow-sm group">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fas fa-water text-gray-400 dark:text-dark-text-secondary group-hover:text-green-500 transition-colors"></i>
                            </div>
                            <input type="number" name="water" id="water" 
                                ...
                                required>
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 dark:text-dark-text-secondary sm:text-sm">m³</span>
                            </div>
                        </div>
                        <p class="mt-2 text-sm text-gray-500 dark:text-dark-text-secondary hidden" id="waterHelp">
                            Enter your monthly water consumption in cubic meters (m³)
                        </p>
                    </div>
                </div>
