...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-slate-400 text-xs sm:text-sm mt-1">Daftarkan hadiah atau voucher keberlanjutan baru untuk ditukarkan pengguna.</p>
        </div>
    ...
    <div class="glass-card p-6 sm:p-8">
        <form action="{{ route('admin.rewards.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       placeholder="Misal: Bibit Pohon Mangrove / Voucher Belanja Hijau 50K" 
                       required 
                       class="admin-input">
                @error('reward_name')
            ...
            <div>
                ...
                <textarea id="reward_description" 
                          ...
                          rows="4" 
                          placeholder="Jelaskan manfaat reward, masa berlaku voucher, dan cara penukaran..." 
                          required 
                          class="admin-input">{{ old('reward_description') }}</textarea>
