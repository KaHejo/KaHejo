<!-- C:\Users\Daniel Lincoln\Documents\GitHub\KaHejo\kahejo\resources\views\emission-factors\index.blade.php -->
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="flex justify-between items-center px-6 py-4 border-b">
                ...
                <a href="{{ route('admin.emission-factors.create') }}" class="bg-green-600 hover:bg-green-700 text-white text-sm px-4 py-2 rounded-full inline-flex items-center">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('admin.emission-factors.edit', $factor) }}" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">
                                            Edit
                                        </a>
                                        <form action="{{ route('admin.emission-factors.destroy', $factor) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                            @csrf
                                            @method('DELETE')
