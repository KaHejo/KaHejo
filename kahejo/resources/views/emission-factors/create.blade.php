...
@section('content')
    <div class="max-w-2xl mx-auto px-4 py-6">
        ...
        <form action="{{ route('emission-factors.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow space-y-5">
            @csrf
            ...
            <div class="flex justify-between items-center mt-6">
                <a href="{{ route('emission-factors.index') }}" class="text-gray-600 hover:text-gray-800">← Kembali</a>
